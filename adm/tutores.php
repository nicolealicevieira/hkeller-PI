...
$conn = openCon();
$query = "SELECT id, nome, email, senha, cpf, dt_nasc, telefone, fg_status, fg_permissao, dt_reg, dt_up FROM hkeller.usuario WHERE fg_status=1;";
$rs = $conn->query($query);
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<body style="background: #1a392d;color: #94c21c;">
        ...
        <div class="table-responsive text-center" style="background: #326d56;color: rgb(148,194,28);--bs-body-color: #94c21c;">
            <table class="table table-hover table-borderless">
                ...
                <tbody>
                        ...
                        <td><?php if($row['fg_permissao']==2){echo 'Tutor';}else if($row['fg_permissao']==1){echo 'ADM';}?></td>
                        <td>
                ...
                <div class="row" style="padding-top: 8px">
                    <div class="col-md">
                        <div class="form-floating" style="background: #1a392d;color: #94c21c;">
                          <select class="form-select" id="cad-perm" style="background: #1a392d;color: #94c21c;" name="perm" required>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var grupoField = document.getElementById("cad-perm");
